...
desktop. It is intended to be very minamilist rice with only what I need, no
extra bloat
...
I would also want to give a special acknowledgement to the
https://dwm.suckless.org/patches/nametag/[nametag] patch. My mmnametag patch is
just an edit of this patch.
