...
3. cd to this directory and run `./install`
4. Exit your shell and relogin so you have the new zsh shell
5. Run `startx` to start your graphical environment (dwm)
6. (optional) Once in dwm press *Super-Shift-Enter* to start alacritty
7. (optional) cd to this repository
8. (optional) run `./after-startx` and follow the instructions

== Q and A

=== Why Ubuntu?
Even though I have used other minimal distrobutions such as Gentoo and Arch
Linux, I still perfer Ubuntu. Why, you ask? That is because it has a very large
...
I could have also made the whole process a bit better, for example, grabing the
vulkan sdk from the website instead of storing it here. But this is a work in
