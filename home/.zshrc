...
if [ -f $HOME/.config/zsh/zsh-vim-mode/zsh-vim-mode.plugin.zsh ]; then
	. $HOME/.config/zsh/zsh-vim-mode/zsh-vim-mode.plugin.zsh 
...
if [ -f $HOME/.config/zsh/zsh-extract/extract.plugin.zsh ]; then
	. $HOME/.config/zsh/zsh-extract/extract.plugin.zsh
fi
